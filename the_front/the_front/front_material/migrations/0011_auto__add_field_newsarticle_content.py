...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsArticle.content'
        db.add_column(u'front_material_newsarticle', 'content',
                      self.gf('tinymce.models.HTMLField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsArticle.content'
        db.delete_column(u'front_material_newsarticle', 'content')
