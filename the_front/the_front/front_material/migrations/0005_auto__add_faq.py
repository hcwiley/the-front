...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FAQ'
        db.create_table(u'front_material_faq', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topic', self.gf('django.db.models.fields.CharField')(default='', max_length=100)),
            ('answer', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
        ))
        db.send_create_signal(u'front_material', ['FAQ'])


    def backwards(self, orm):
        # Deleting model 'FAQ'
        db.delete_table(u'front_material_faq')
