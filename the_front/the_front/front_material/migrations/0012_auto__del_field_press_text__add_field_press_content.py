...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'front_material_press', 'text')

        # Adding field 'Press.content'
        db.add_column(u'front_material_press', 'content',
