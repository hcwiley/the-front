...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NewsArticle.name'
        db.alter_column(u'front_material_newsarticle', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'NewsArticle.name'
        db.alter_column(u'front_material_newsarticle', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
