...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ArtistMedia.full_res'
        db.delete_column(u'artist_artistmedia', 'full_res')
    ...
    def backwards(self, orm):
        # Adding field 'ArtistMedia.full_res'
        db.add_column(u'artist_artistmedia', 'full_res',
                      self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)
