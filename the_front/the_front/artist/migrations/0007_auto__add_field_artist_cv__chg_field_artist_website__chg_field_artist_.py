...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Artist.cv'
        db.add_column(u'artist_artist', 'cv',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Artist.website'
        db.alter_column(u'artist_artist', 'website', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Artist.email'
        db.alter_column(u'artist_artist', 'email', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Artist.cv'
        db.delete_column(u'artist_artist', 'cv')


        # Changing field 'Artist.website'
        db.alter_column(u'artist_artist', 'website', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Artist.email'
        db.alter_column(u'artist_artist', 'email', self.gf('django.db.models.fields.CharField')(max_length=100))
