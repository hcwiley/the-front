...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArtistMedia.position'
        db.add_column(u'artist_artistmedia', 'position',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArtistMedia.position'
        db.delete_column(u'artist_artistmedia', 'position')
    ...
    models = {
        ...
        u'artist.artistmedia': {
            'Meta': {'ordering': "('position',)", 'object_name': 'ArtistMedia', '_ormbases': [u'front_material.FrontMedia']},
