...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'artist_artistmedia', (
            ...
            ('full_res', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'artist.artistmedia': {
            ...
            'full_res': ('django.db.models.fields.files.ImageField', [], {'default': "''", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
